...
const LINES = [
    { t: 1.55, text: "밀양 월영루. 밤마다 그 위에 붉은 나비가 난다." },
    { t: 5.35, text: "새로 부임한 수령들은 첫날밤을 넘기지 못했다." },
    { t: 9.05, text: "사람들은 귀신의 소행이라며 입을 다문다." },
    { t: 12.35, text: "나는 암행어사. 떠돌이 선비로 신분을 숨기고 들어왔다." },
    { t: 15.15, title: "붉은 나비", text: "먼저, 월영루의 여인에게 사건을 물어보자." }
];
